...
# made by: Engells
# date: Jul 9, 2026
# content: Enable weekly trim SSD, and add a package of libwebp-utils
...
{
setfont ter-128n
cat /sys/firmware/efi/fw_platform_size && sleep 5
ip link && ping -c3 archlinux.org
...
_bld_virt()
{
pkgcols='qemu-full swtpm virt-manager virt-viewer edk2-ovmf dnsmasq vde2 bridge-utils iptables-nft openbsd-netcat libguestfs guestfs-tools multipath-tools lxc podman distrobox flatpak'
_insall_pkgs
