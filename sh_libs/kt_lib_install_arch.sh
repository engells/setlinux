...
# made by: Engells
# date: Feb 21, 2024
# content: Add okular in list of install pkgs
...
mount -o defaults,ssd,compress=zstd:3,subvol=${hname}/home /dev/${dname}${pnum} /mnt/home/${uname}0
...
_bld_gui()
{
pkgcols='xorg xorg-server xorg-xlogo xbitmaps xdg-user-dirs pipewire pipewire-pulse pipewire-alsa pipewire-jack wireplumber sddm plasma-desktop plasma-wayland-session plasma-nm plasma-pa dolphin konsole okular gwenview kate kscreen ark systemsettings kde-gtk-config breeze-gtk qt5-imageformats kimageformats5 kwalletmanager'
_insall_pkgs
sudo systemctl enable sddm.service
# xorg-server-xephyr xorg-server-xvfb xpra ;; steghide imagemagick => distrobox # pulseaudio
}
