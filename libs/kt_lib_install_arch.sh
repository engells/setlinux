...
for vname in os res pkgs snapshots os/arch res/arch pkgs/arch mass ; do btrfs subvolume create /mnt/$vname ; done
for vname in home mnt data imgs blks flatpak lxcd lxcu lxdu podman ; do btrfs subvolume create /mnt/mass/$vname ; done
