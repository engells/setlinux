...
_bash_conf()
{
  ...
  for dotFile in bash_profile bashrc bash_logout bash_history
  do
...
_tmux_conf()
{
  ...
  cp -v $cfgDir/confs_sys/shell_tmux_conf           $tDir/tmux_conf
  ...
  ln -s $tDir/tmux_conf                             $HOME/.config/tmux/tmux.conf    # or link to $HOME/.tmux.conf
